    ...
    $.ajax({
        ...
        success: function(result){
            ...
            for(var i = 0; i < x.length; i++) {
                ...
                $output.append('<label>Course ID :</label>' + '<input type="text"' + i + '" id="textbox' + i + '" value="'+x[i].aq_id+'" ><br>');
                $output.append('<label>Course Name :</label>' + '<input type="text" size="60"' + i + '" id="textbox' + i + '" value="'+x[i].aq_title+'" ><br>');
                $output.append('<label>Academic Level :</label>' + '<input type="text"' + i + '" id="textbox' + i + '" value="'+x[i].aq_level+'" ><br>');
                $output.append('<label>Institute :</label>' + '<input type="text" size="60"' + i + '" id="textbox' + i + '" value="'+x[i].aq_institute+'" ><br>');
                $output.append('<label>Description :</label>' + '<input type="text" size="60"' + i + '" id="textbox' + i + '" value="'+x[i].aq_description+'" ><br><br>');
            }
        }
    });
    ...
    $.ajax({
        ...
        success: function(result){
            ...
            for(var i = 0; i < x.length; i++) {
                ...
                $output.append('<label>Title :</label>' + '<input type="text" size="60"' + i + '" id="textbox' + i + '" value="'+x[i].pq_title+'" ><br>');
                $output.append('<label>Academic Level :</label>' + '<input type="text"' + i + '" id="textbox' + i + '" value="'+x[i].pq_level+'" ><br>');
                $output.append('<label>Institute :</label>' + '<input type="text" size="60"' + i + '" id="textbox' + i + '" value="'+x[i].pq_institute+'" ><br>');
                $output.append('<label>Description :</label>' + '<input type="text" size="60"' + i + '" id="textbox' + i + '" value="'+x[i].pq_description+'" ><br><br>');
            }
        }
    });
