...
<!--            </div>-->
<!--        </div>-->
<!--        <p style="font-size: small">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rate academic + </p>-->
...
<br>
    <div class="unit" style='margin-bottom:20px !important;'>
        <div class="field name" style='margin-left:100px'>
            <div  id="overallrating">
                <fieldset class="overallrating">
                    <input type="radio" id="star5" name="overallrating" value="5" /><label class = "full" for="star5" title="Very Good"></label>
                    <input type="radio" id="star4half" name="overallrating" value="4 and a half" /><label class="half" for="star4half" title="Very Good"></label>
                    <input type="radio" id="star4" name="overallrating" value="4" /><label class = "full" for="star4" title="Good"></label>
                    <input type="radio" id="star3half" name="overallrating" value="3 and a half" /><label class="half" for="star3half" title="Good"></label>
                    <input type="radio" id="star3" name="overallrating" value="3" /><label class = "full" for="star3" title="Average"></label>
                    <input type="radio" id="star2half" name="overallrating" value="2 and a half" /><label class="half" for="star2half" title="Average"></label>
                    <input type="radio" id="star2" name="overallrating" value="2" /><label class = "full" for="star2" title="Poor"></label>
                    <input type="radio" id="star1half" name="overallrating" value="1 and a half" /><label class="half" for="star1half" title="Poor"></label>
                    <input type="radio" id="star1" name="overallrating" value="1" /><label class = "full" for="star1" title="Very Poor"></label>
                    <input type="radio" id="starhalf" name="overallrating" value="half" /><label class="half" for="starhalf" title="Very Poor"></label>
                </fieldset>
            </div>
        </div>

        <input style='margin-left:50px' class="btn btn-info" id="rateprofile" type="button" value="Rate profile">
        <input style='margin-left:50px' class="btn btn-info" id="commentprofile" type="button" value="Comment">
    </div>
<br>
